            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="font-display font-semibold text-dark-text">{t('contact.addressLabel')}</h3>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="font-display font-semibold text-dark-text">{t('contact.phoneLabel')}</h3>
                    <p className="text-dark-text font-body">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="font-display font-semibold text-dark-text">{t('contact.whatsappLabel')}</h3>
                    <p className="text-dark-text font-body">
