...
const Reservations = () => {
  ...
  const whatsappMessage = encodeURIComponent(
    `Hola! Me gustaría hacer una reserva en El Higo. Gracias!\n\nHello! I would like to make a reservation at El Higo. Thank you!`
  );

  const theForkMessage = "Próximamente disponible / Coming soon";
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="text-center">
                ...
                <h3 className="font-display font-semibold text-dark-text mb-2">Teléfono / Phone</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="font-display font-semibold text-dark-text mb-2">Ubicación / Location</h3>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="bg-green-leaf text-white p-6">
                <div className="flex items-center">
                  ...
                  <h3 className="text-xl font-display font-bold">WhatsApp</h3>
                </div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="bg-terracotta text-white p-6">
                <div className="flex items-center">
                  ...
                  <h3 className="text-xl font-display font-bold">TheFork</h3>
                </div>
